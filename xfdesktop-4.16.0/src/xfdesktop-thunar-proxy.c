 ...
 */
guint
xfdesktop_thunar_override_properties (GObjectClass *klass, guint property_id_begin)
{
...
static void
xfdesktop_thunar_proxy_get_property (GObject      *object,
  guint         prop_id,
  GValue       *value,
...
static void
xfdesktop_thunar_proxy_set_property (GObject      *object,
  guint         prop_id,
  const GValue *value,
  GParamSpec   *pspec G_GNUC_UNUSED)
{
...
static void
xfdesktop_thunar_proxy_iface_init (XfdesktopThunarIface *iface)
{
}
...
static void
xfdesktop_thunar_skeleton_dbus_interface_flush (GDBusInterfaceSkeleton *_skeleton)
{
}
...
static void
xfdesktop_thunar_skeleton_iface_init (XfdesktopThunarIface *iface)
{
}
