...
void xfdesktop_file_manager_complete_display_chooser_dialog (
    XfdesktopFileManager *object,
    GDBusMethodInvocation *invocation);
...
/* D-Bus method calls: */
void xfdesktop_file_manager_call_display_chooser_dialog (
...
gboolean xfdesktop_file_manager_call_display_chooser_dialog_finish (
    XfdesktopFileManager *proxy,
    GAsyncResult *res,
    GError **error);

gboolean xfdesktop_file_manager_call_display_chooser_dialog_sync (
    XfdesktopFileManager *proxy,
    const gchar *arg_uri,
    gboolean arg_open,
    const gchar *arg_display,
